...
class CI_Loader {
	...
	public function dbutil()
	{
		...
		require_once(BASEPATH.'database/drivers/'.$this->CI->db->dbdriver.'/'.$this->CI->db->dbdriver.'_utility.php');
	...
	public function dbforge()
	{
		...
		require_once(BASEPATH.'database/drivers/'.$this->CI->db->dbdriver.'/'.$this->CI->db->dbdriver.'_forge.php');
