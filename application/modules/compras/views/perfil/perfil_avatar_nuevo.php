    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-3" data-bind="with:avatarEditar">
                        <img class="img-responsive" data-bind="attr:{src:avatar}">
                    </div>

                    <div class="col-md-9">
                        <p><small>Seleccione algún foto predefinido.</small></p>
                        <div class="row" id="_iP" data-bind="foreach:avatares">
                            <div class="col-sm-6 col-md-3" id="_hob">
                                ...
                                <a class="thumbnail" data-bind="click:$root.perfil.avatar_nuevo_default, attr:{href:imagen}"><img data-bind="attr:{src:avatar}"></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                    <div class="col-md-6">
                        <form action="<?php echo site_url($domain.'/usuarios/api/perfil/UploadFile/'); ?>"  accept-charset="utf-8" role="form" id="uploadImg" method="POST" enctype="multipart/form-data" >
