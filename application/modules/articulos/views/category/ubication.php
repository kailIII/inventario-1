...
<section id="CenterCost">
  <div class="col-md-13">
    <form name="formFamily" id="formFamily">
      <div class="row">
        <div class="col-md-13">
          <div class="col-md-4 col-md-offset-6 form-group">
            <input type="text" class="form-control" name="name" id="ubicationval" placeholder="Ubicacion">
          </div>
...
<div class="row">
  <div class="col-xs-12">
    <div class="panel panel-brown">
            <div class="panel-heading"><h4>Centro de costos</h4></div>
        <div class="panel-body">
            <table class="table table-hover">
               <thead>
                ...
                <tbody >
				<?php foreach($ubicationList as $k => $v): ?>
                   <tr >                    
