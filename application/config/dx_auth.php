...
$config['DX_table_prefix'] = 'app_';
$config['DX_users_table'] = 'users_client';
$config['DX_users_'] = 'users';
// $config['DX_user_profile_table'] = 'user_profile';
$config['DX_user_profile_table'] = 'user_profile_client';
...
$config['DX_password_table'] = 'password';
$config['DX_modules_table'] = 'modules';
$config['DX_user_info'] = 'user_info';
...
$config['DX_salt'] = "Jq3DMF=E'U4Ff!v<W5s{1GDbSH'}D+Kq4g80j/9P{Db.u|iEFHlMm:_KTEdF<p3";
